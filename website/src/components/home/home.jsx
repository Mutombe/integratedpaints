...
import { ChevronRight, Star, Building, Home as HomeIcon, Factory } from 'lucide-react';
      ...
      <section className="relative h-screen">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          ...
          >
            ...
            <button className="bg-primary hover:bg-primary/90 text-white px-8 py-3 rounded-full flex items-center space-x-2 transition-colors">
